...
class TankIA(Tank):
    def __init__(self, x, y, width, height, base_image_path, turret_image_path, angle):
        super().__init__(x, y, width, height, base_image_path, turret_image_path, None, None, None, None, None, None, angle)
...
def main():
    ...
    tank_ia = TankIA(WIDTH - 100, HEIGHT // 2, 80, 80, 'Jeu de tank/assets/MainCharacters/Tank/tank_base_P2.png', 'Jeu de tank/assets/MainCharacters/Tank/tank_turret_P2.png', 180)
    tanks = [tank1, tank_ia]
    bullets = []

    en_jeu = True
    menu_actif = False #L'un des 2 doit etre True ou False
    ...
    while running:
        ...
        if menu_actif:
            ...
            if en_jeu:
                ...
                tank1.move(delta_time, box)
                tank_ia.decide_action(tanks, box)  # Appel de l'action de l'IA
                for tank in tanks:
                ...
                reload_status_P2 = tank_ia.get_reload_status()
                ...
                afficher_coordonner_P1 = tank1.coordonee()
                afficher_coordonner_P1 = status_font.render(afficher_coordonner_P1, True, RED)
                window.blit(afficher_coordonner_P1, (10, HEIGHT - afficher_coordonner_P1.get_height() - 30))
                
                afficher_coordonner_P2 = tank_ia.coordonee()
                afficher_coordonner_P2 = status_font.render(afficher_coordonner_P2, True, RED)
                window.blit(afficher_coordonner_P2, (WIDTH - afficher_coordonner_P2.get_width() - 10, HEIGHT - afficher_coordonner_P2.get_height() - 30))
